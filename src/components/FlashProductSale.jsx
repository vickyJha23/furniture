        ...
        <div className='flex w-full flex-col xl:flex-row gap-10 items-center'>
            <div className='w-full lg:w-1/2 flex justify-center items-center'>
              <div className='w-[60%] space-y-4 flex flex-col items-center lg:items-start'>
                  <p className='flex justify-center lg:justify-start items-center gap-4'><span className='inline-block w-[14px] h-[14px] bg-orange-500 -rotate-45 shadow'></span> <span className='uppercase tracking-[2px] text-orange-500'>shop now save</span></p>
                   <h2 className='text-4xl font-bold font-PlayFair text-center mx-auto lg:mx-0 lg:text-left max-w-[350px]'>Hurry! Deals End Soon!</h2>
